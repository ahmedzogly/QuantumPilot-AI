...
export default function CopilotChat() {
  ...
  const handlePlan = async () => {
    ...
    try {
      ...
      let type = "balanced"
      if (lower.includes("cost") || lower.includes("cheap")) type = "cheapest"
      else if (lower.includes("fidelity") || lower.includes("95")) type = "highest_fidelity"
      else if (lower.includes("fast")) type = "fastest"
      else if (lower.includes("space") || lower.includes("storm") || lower.includes("kp")) type = "avoid_space_weather"
      ...
      setPlan({
        ...
        plan: {
          ...
          explanation: type==="cheapest" ? "Selected lowest cost: S-ZNE 1.2x vs 5x, 76 percent saving." : 
                       type==="highest_fidelity" ? "Selected highest fidelity: ibm_kingston T1 231us, opt 3, pec, 8192 shots." :
                       "Selected balanced optimal - Bilingual AR/EN supported.",
